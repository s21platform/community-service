...
// SendLinkingCode operation middleware
func (siw *ServerInterfaceWrapper) SendLinkingCode(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params SendLinkingCodeParams
