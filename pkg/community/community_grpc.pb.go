...
const (
	...
	CommunityService_CheckAuthCode_FullMethodName           = "/CommunityService/CheckAuthCode"
)
...
type CommunityServiceClient interface {
	...
	CheckAuthCode(ctx context.Context, in *CodeConfirmIn, opts ...grpc.CallOption) (*CodeConfirmOut, error)
}
...
func (c *communityServiceClient) CheckAuthCode(ctx context.Context, in *CodeConfirmIn, opts ...grpc.CallOption) (*CodeConfirmOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CodeConfirmOut)
	err := c.cc.Invoke(ctx, CommunityService_CheckAuthCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommunityServiceServer interface {
	...
	CheckAuthCode(context.Context, *CodeConfirmIn) (*CodeConfirmOut, error)
...
func (UnimplementedCommunityServiceServer) CheckAuthCode(context.Context, *CodeConfirmIn) (*CodeConfirmOut, error) {
...
func _CommunityService_CheckAuthCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CodeConfirmIn)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommunityServiceServer).CheckAuthCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommunityService_CheckAuthCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommunityServiceServer).CheckAuthCode(ctx, req.(*CodeConfirmIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommunityService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CommunityService_CheckAuthCode_Handler,
		},
	},
